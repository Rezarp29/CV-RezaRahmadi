...
const Hero: React.FC = () => {
  ...
  return (
    <section className={`
      rounded-lg p-8 flex flex-col md:flex-row items-center
    ...
    `}>
      ...
      <div className="md:w-2/3 md:pl-6">
        <div className="flex items-center mb-2">
          ...
          `} />
          <h1 className="text-3xl font-bold">Reza Rahmadi Putra</h1>
        </div>
        ...
        <div className="flex items-center mb-4">
          <FaMapMarkerAlt className={`mr-2
            ...
            ${theme === 'red' ? 'text-red-300' : ''}
          `} />
          <span className="text-lg">Bandung, Jawa Barat</span>
        </div>
        ...
        <div className="flex items-center mb-4">
          <FaUniversity className={`mr-2 text-xl
            ...
            ${theme === 'red' ? 'text-red-300' : ''}
          `} />
          <span className="text-lg">Mahasiswa S1 Sistem Informasi - Ma'soem University</span>
        </div>
